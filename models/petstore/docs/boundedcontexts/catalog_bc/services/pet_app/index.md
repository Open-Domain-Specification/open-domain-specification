...
| ReservePetForOrder | operation | no | open-host-service | POST /pet/{petId}/reserve; holds the pet for an approved order by running the aggregate's ReservePet | [PetId](../../index.md#schemas) | - | PetStatusChanged | - |
