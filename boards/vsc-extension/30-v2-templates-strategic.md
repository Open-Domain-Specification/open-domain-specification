...
- [ ] `v2/templates/`: WorkspacePage, DomainPage, SubdomainPage, ContextPage, RelationshipPage, TeamPage, HealthPage, each rendered inside `v2/PageLayout` in a `V2/Templates/...` story against petstore, light, dark and high contrast
