...
- [x] The flow map, consumable page "Raises" and doc generator show the front's reachable events as reached, not declared, where a reader would otherwise miss them (the lead decides the wording with the design lead if a new mark is needed; otherwise a sentence under the list)
