...
- **dev-lite** (2026-09-05T00:00:00.000Z): QUESTION for lead — two attributes the card names don't have a clean `identifies` target and I left them bare rather than guess:
