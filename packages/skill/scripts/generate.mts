...
const coreVersion: string = require(join(corePkg, "package.json")).version;

const GENERATED_HEADER = (source: string) =>
	`<!-- Generated by packages/skill/scripts/generate.mts from @open-domain-specification/core ${coreVersion} (${source}); do not edit. -->\n`;
