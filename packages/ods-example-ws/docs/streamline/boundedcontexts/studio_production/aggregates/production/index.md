...
| --- | --- | --- | --- |
| Entity (Root) | **Production** | A commissioned film or series | **productionId**: `string`, workingTitle: `string`, greenlitOn: `date` |
...
| --- | --- | --- |
| BudgetApprovedBeforeShoot | No shoot starts before the budget is approved | Budget, Production |
