...
| --- | --- | --- | --- |
| Entity (Root) | **Title** | One film or series | **titleId**: `string`, name: `string`, kind: `'film' | 'series'`, rating: `MaturityRating` |
| Entity | Episode | What a member plays; carries artwork and a rating, unlike the studio's episode | **episodeId**: `string`, playableRenditionSet: `string` |
...
| --- | --- | --- |
| PublishedTitleHasPlayableAsset | A title is published only when at least one episode has a completed encode | Title, Episode |
