...
<!-- A workspace page: no crumbs, no description, no facts — just the title
     lockup with its id and the kind word after it. -->
<Story name="Title only">
	{#snippet template()}<Theme mode="light"><Demo bare /></Theme>{/snippet}
</Story>
