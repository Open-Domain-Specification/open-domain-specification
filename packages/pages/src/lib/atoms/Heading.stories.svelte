...
const { Story } = defineMeta({ title: "Atoms/Heading", component: Heading });
</script>
...
<Story name="Without counts">
	{#snippet template()}<Theme mode="light"><Demo withCounts={false} /></Theme>{/snippet}
</Story>
